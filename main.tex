...
The proposed class dependent, sigmoid loss achieves both better pre-training performance and better fine-tuning performance than the weighting the classes in the presence of missing segmentations.
