...
However, it can be challenging to employ the ImageNet CNN models directly for semantic segmentation.
...
\begin{enumerate}
  ...
  \item We propose to learn representations by training foreground/background segmentations if the segmentation labels are noisy.
