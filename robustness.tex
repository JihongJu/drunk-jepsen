\section{Noise robustness for convolutional feature transferability}
...
% We formulated our research question as follows:
% \begin{enumerate}
  % \item  Is transferability of convolution neural networks negatively influenced by label noises?
% \end{enumerate}
